...
fun FiltrowanaListaRoute(
    ...
    val viewModel: FiltrowanaListaViewModel = viewModel(
        factory = FiltrowanaListaViewModelFactory(rodzaj, kategoriaRepository, produktRepository)
    )
    val stan by viewModel.stan.collectAsStateWithLifecycle()
    FiltrowanaListaScreen(
        stan = stan,
        naWstecz = naWstecz,
...
@Composable
fun FiltrowanaListaScreen(
    stan: FiltrowanaListaUiState,
    naWstecz: () -> Unit,
